...
function DialogButton({ handleClose, handleClick, isLoading }: HeaderProps) {
    return (
        <>
            <div className="flex gap-1.5 justify-end mt-5">
                ...
                <button
                    ...
                    onClick={handleClick}
                    disabled={isLoading}
                    className="flex w-full justify-center rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 disabled:bg-gray-300 disabled:text-gray-500 sm:w-auto">
                    {isLoading &&
                        (
