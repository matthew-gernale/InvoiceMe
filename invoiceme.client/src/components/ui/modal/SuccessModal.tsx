...
const SuccessModal = () => {
    const [notification, setNotification] = useState<SuccessModalData | null>(null);
    ...
    return createPortal(
        <Modal
            isOpen={true}
            onClose={handleClose}
            className="max-w-sm p-4 lg:p-5 m-4"
        >
            <div className="flex flex-col items-center text-center font-poppins pb-5">
                <div className="flex justify-center mt-5 mb-2.5">
                    <img src="/images/gif/check.gif"
                        style={{
                            width: '100px',
                            height: '100px',
                            objectFit: 'contain',
                ...
                <span className="text-[13px] font-normal text-[#8a9499] tracking-[0.5px]">
                    {message ? message : 'Your entry has been submitted successfully!'}
                </span>
