...
export default function PaginatedTable({
    ...
    const handleSearchFunc = async () => {
        if (onSearchValueChange) await onSearchValueChange(searchInput);
    }

    return (
        <div className="rounded-xl bg-white min-w-fit dark:bg-white/[0.03]">
            ...
            <div className="max-w-full custom-scrollbar overflow-visible">
