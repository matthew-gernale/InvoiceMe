...
import { AddClientDTO, ClientDTO } from '../../@types/client.type';
...
function AddClientModal(props: AddClientModalProps) {
    ...
    return (
        <Modal isOpen={props.isOpen} className='max-w-2xl m-4' onClose={handleCancelBtn}>
            <div className='p-6 rounded-lg'>
                <p className='font-semibold border-b border-gray-300 pb-2 mb-4'>Add new Client</p>
