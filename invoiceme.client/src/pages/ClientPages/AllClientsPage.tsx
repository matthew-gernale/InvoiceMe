...
function AllClientsPage() {
    ...
    const [isShowAddClient, showAddClient] = useState(false);
    ...
    const handleAddClientResult = (isSuccess: boolean, newClient: ClientDTO) => {
        if (isSuccess) {
    ...
    return (
        <>
            <PageMeta
                title="InvoiceMe | Clients"
                description="This page shows clients"
            />
            ...
            <PageBreadCrumb
                ...
                onBtnclick={() => showAddClient(true)}
            />

            <AddClientModal isOpen={isShowAddClient} onClose={handleAddClientResult} />
            <ApprovalModal
                isOpen={isShowApprovalModal}
                onClose={handleApproval}
                title='Delete confirmation'
                description={`Are you sure you want to remove ${selectedClient.Name} in your client list?`}
                submitBtnClass='bg-red-600 text-white hover:bg-red-500 transition ease-in-out'
                submitBtn='Confirm'
            />
