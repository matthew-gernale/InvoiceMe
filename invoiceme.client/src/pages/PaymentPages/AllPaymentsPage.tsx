...
import { Eye, List, FileClock, ClipboardX } from 'lucide-react'
...
function AllPaymentsPage() {
    ...
    const handleApplyFilter = async (status: ApprovalStatus | null) => {
        setIsTableLoading(true);
        const statusChangePayload = new GetPaginatedDTO();
        statusChangePayload.ApprovalStatus = status;
    ...
    const getPaymentCountByStatus = async () => {
        const response = await paymentService.getPaymentCountsByStatus();
    ...
    return (
        <>
            <PageMeta
                title="InvoiceMe | Payments"
                description="This page shows client payments"
            />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 mb-5">
                ...
                <div>
                    <CardCount
                        ...
                        OnClick={() => handleApplyFilter(ApprovalStatus.PENDING)}
                ...
                <div>
                    <CardCount
                        ...
                        OnClick={() => handleApplyFilter(ApprovalStatus.APPROVED)}
                ...
                <div>
                    <CardCount
                        ...
                        OnClick={() => handleApplyFilter(ApprovalStatus.REJECTED)}
